...
void add_note(struct market spare_parts[], int n)
{
    int price;
...
void all_notes(struct market spare_parts[], int n)
{
    for (int i = 0; i < n; i++)
...
void del_note(struct market spare_parts[], int n, int del)
{
    for (int i = del; i < n - 1; i++)
    {
        struct market temp = spare_parts[i];
