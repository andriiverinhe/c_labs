...
void informathio()
{
    ...
    printf("Enter \"delit (number note)\" if you want to delete a note\n"); 
    printf("Enter \"list\" if you want to see all notes\n_________________________________________________________\n\n");  
}
...
int main() {
        ...
        while (strcmp(query, "exit"))
    {
        ...
        else if (!strcmp(query, "list"))
            all_notes(computer, count);
        
        else if (!strcmp(query, "delit"))
        {
